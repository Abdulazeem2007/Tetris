...
function updateScore() {
  ...
  textSize(12);
  text("Coded by: Abdulazeem Shaikh", (grid.columns + 1.75) * grid.cellSize, grid.cellSize * (grid.rows - 1));
  text("Happy Teachers Day", (grid.columns + 1.75) * grid.cellSize, grid.cellSize * (grid.rows - 0.5));
  text("Code.whitehatjr.com", (grid.columns + 1.75) * grid.cellSize, grid.cellSize * (grid.rows));
  pop();
}
